...
internal class UnimplementedContainer(string id) : Container
{
    ...
    public override Database Database { get; } = null!;
    public override Conflicts Conflicts { get; } = null!;
    public override Scripts Scripts { get; } = null!;
}
