...
public class TemplateMatchContextTests
{
    ...
    {
        var context = new TemplateMatchContext(_season, Array.Empty<DivisionDataDto>());
    ...
    public void GetSeasonSharedAddresses_GivenTeams_ReturnsEmpty()
    {
        ...
        var context = new TemplateMatchContext(_season, new[] { division });
    ...
    {
        var team1 = new DivisionTeamDto { Address = "A" };
        var team2 = new DivisionTeamDto { Address = "B" };
        var division = new DivisionDataDto
        {
            Teams = { team1, team2 },
        };
    ...
    public void GetSeasonSharedAddresses_GivenSomeTeamsWithSharedAddressesInADivision_ReturnsEmpty()
    {
        var team1 = new DivisionTeamDto { Address = "A" };
        var team2 = new DivisionTeamDto { Address = "B" };
        var team3 = new DivisionTeamDto { Address = "A" };
        var division = new DivisionDataDto
        {
    ...
    public void GetSeasonSharedAddresses_GivenSomeTeamsWithSharedAddressesAcrossDivisions_ReturnsSharedAddresses()
    {
        ...
        var team2 = new DivisionTeamDto { Address = "B" };
        var team3 = new DivisionTeamDto { Address = "A" };
        var team4 = new DivisionTeamDto { Address = "C" };
        var team5 = new DivisionTeamDto { Address = "B" };
        var team6 = new DivisionTeamDto { Address = "C" };
        ...
        {
            Teams = { team4, team5, team6 },
        };
        var context = new TemplateMatchContext(_season, new[] { division1, division2 });
    ...
    public void SharedAddressesFromSeason_GivenNoTeams_ReturnsEmpty()
    {
        ...
        var mapping = new TemplateMatchContext.DivisionSharedAddressMapping(seasonDivision, templateDivision);
    ...
    public void SharedAddressesFromSeason_GivenUniqueAddressesForEachTeam_ReturnsEmpty()
    {
        var team1 = new DivisionTeamDto { Address = "A" };
        var team2 = new DivisionTeamDto { Address = "B" };
        var team3 = new DivisionTeamDto { Address = "C" };
        var seasonDivision = new DivisionDataDto
        {
            Teams = { team1, team2, team3 }
        };
