...
public class CreateTournamentMatchSaygCommandTests
{
    ...
    public async Task ApplyUpdate_WithoutHomeOrAwaySides_ReturnsUnsuccessful()
    {
        ...
        Assert.That(result.Success, Is.False);
        Assert.That(result.Errors, Is.EqualTo(["Match does not have both sides set"]));
    }
    ...
    public async Task ApplyUpdate_WithExistingSaygForMatch_ReturnsSuccessful()
    {
        ...
        Assert.That(result.Warnings, Is.EqualTo(["Match already has a sayg id"]));
    }
    ...
    public async Task ApplyUpdate_WithNoSaygForMatchAndUnableToCreate_ReturnsUnsuccessful()
    {
        ...
        Assert.That(result.Errors, Is.EqualTo(["Some error adding sayg"]));
        _addSaygCommand
            .Verify(s => s.WithData(
