...
export default class OldApp extends Component {
    constructor(props) {
        ...
        this.divisionApi = new DivisionApi(new Http(new Settings()));
        this.accountApi = new AccountApi(new Http(new Settings()));
        this.seasonApi = new SeasonApi(new Http(new Settings()));
