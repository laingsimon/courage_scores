        ...
        it('league fixture', async () => {
            ...
            await renderComponent(
                ...
                divisionDataBuilder(division)
                    ...
                    .withFixtureDate(fd => fd.withFixture((f: IDivisionFixtureBuilder) => f.playing(teamBuilder('HOME'), team).scores(3, 1), fixtureId), '2023-05-06T00:00:00')
                    .season(s => s.withDivision(division), 'SEASON')
                    .build());
        ...
        it('league fixture with no scores', async () => {
            ...
            await renderComponent(
                ...
                divisionDataBuilder(division)
                    .withTeam(team)
                    .withPlayer(playerWithLeagueFixture)
                    .withFixtureDate(fd => fd.withFixture((f: IDivisionFixtureBuilder) => f.playing(teamBuilder('HOME'), team).scores(undefined, undefined), fixtureId), '2023-05-06T00:00:00')
                    .season(s => s.withDivision(division), 'SEASON')
                    .build());
        ...
        it('league knockout fixture', async () => {
            ...
            await renderComponent(
                ...
                divisionDataBuilder(division)
                    .withTeam(team)
                    .withPlayer(playerWithLeagueFixture)
                    .withFixtureDate(fd => fd.withFixture((f: IDivisionFixtureBuilder) => f.playing(team, teamBuilder('AWAY'))
                        .knockout()
