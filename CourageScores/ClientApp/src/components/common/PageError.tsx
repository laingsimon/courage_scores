        ...
        <div className="content-background p-3">
            ...
            <p>
                <span className="fw-bold">
                    {(error as IError).message || (error as string)}
                </span>
                {(error as IError).stack ? (
                    <span className="form-switch margin-left">
                        ...
                        />
                        <label
                            className="margin-left form-check-label"
                            htmlFor="showStack">
                            Show stack
                        </label>
                    </span>
            ...
            {showStack && (error as IError).stack ? (
                <pre>{(error as IError).stack}</pre>
            ) : null}
            <button
            ...
            <button
                ...
                onClick={invalidateCacheAndTryAgain}>
                Refresh data
            </button>
        </div>
    );
