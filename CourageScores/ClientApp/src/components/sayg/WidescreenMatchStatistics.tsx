...
export function WidescreenMatchStatistics({legs, homeScore, awayScore, home, away, singlePlayer, numberOfLegs, changeStatisticsView }: IWidescreenMatchStatisticsProps) {
    ...
    return (<div datatype="WidescreenMatchStatistics" className="d-flex flex-row position-absolute top-0 left-0 right-0 bottom-0 p-3 bg-white">
        ...
        {singlePlayer ? null : (<>
            ...
            <div datatype="away-column" className="d-flex flex-column flex-grow-1 flex-shrink-1 flex-basis-0">
                ...
                <WidescreenSaygPlayer player="away" legs={legs} scoreFirst={true} finished={finished} />
