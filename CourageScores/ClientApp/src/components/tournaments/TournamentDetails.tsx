...
export function TournamentDetails({
    ...
    function getExportTables(): { [key: string]: string[] } {
        ...
        while (round) {
            saygDataIds = saygDataIds.concat(
                round!
                    .matches!.filter((m: TournamentMatchDto) => m.saygId)
        ...
        <>
            ...
            <div className="input-group mb-1" datatype="address">
                <div className="input-group-prepend">
                    <label
                        htmlFor="address"
                        className="input-group-text width-75">
                        Address
                    </label>
                </div>
                <input
            ...
            <div className="form-group input-group mb-1" datatype="type">
                <div className="input-group-prepend">
                    <label htmlFor="type" className="input-group-text width-75">
                        Type
                    </label>
                </div>
                <input
            ...
            <div
                ...
                <div className="form-control">
                    <div
                        ...
                        <label htmlFor="bestOf" className="input-group-text">
                            Best of
                        </label>
                        <input
                            disabled={disabled}
                            className="form-control no-spinner width-50 d-inline"
                            id="bestOf"
                            type="number"
                            min="3"
                            value={tournamentData.bestOf || ''}
                            name="bestOf"
                    ...
                    <div
                        className="form-check form-switch margin-right my-1"
                        datatype="accolades-count">
                        <input
                            disabled={disabled}
                            type="checkbox"
                        ...
                        <label
                            ...
                            htmlFor="accoladesCount">
                            Include 180s and Hi-checks in players table?
                        </label>
                    </div>
                    <div
                        className="form-check form-switch margin-right my-1"
                        datatype="exclude-from-reports">
                        <input
                            disabled={disabled}
                            type="checkbox"
                            className="form-check-input"
