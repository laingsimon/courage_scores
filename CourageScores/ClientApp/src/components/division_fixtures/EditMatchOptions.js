...
export function EditMatchOptions({ matchOptions, onMatchOptionsChanged, hideNumberOfPlayers }) {
    return (<div>
        ...
        <div className="input-group my-3">
            ...
            <input type="number" className="form-control" value={matchOptions.startingScore} name="startingScore" onChange={valueChanged(matchOptions, onMatchOptionsChanged)} />
        </div>
        <div className="input-group my-3">
            <div className="input-group-prepend">
                <span className="input-group-text">Number of legs</span>
            </div>
            <input type="number" className="form-control" value={matchOptions.numberOfLegs} name="numberOfLegs" onChange={valueChanged(matchOptions, onMatchOptionsChanged)} />
        </div>
    </div>)
}