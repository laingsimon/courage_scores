    ...
    describe('when logged out', () => {
        ...
        it('renders unplayed fixture', async () => {
            ...
            await renderComponent(
                ...
                divisionDataBuilder(division)
                    .withFixtureDate((d: IDivisionFixtureDateBuilder) => d.withFixture(f => f.playing('HOME', 'AWAY')), date)
                    .season(s => s, 'SEASON')
                    .withTeam(team)
                    .build(),
                account,
        ...
        it('renders postponed fixture', async () => {
            ...
            await renderComponent(
                {fixture, date, readOnly: false, beforeReloadDivision, onUpdateFixtures},
                divisionDataBuilder(division)
                    .withFixtureDate((d: IDivisionFixtureDateBuilder) => d.withFixture(f => f.postponed().playing('HOME', 'AWAY')), date)
                    .season(s => s, 'SEASON')
                    .withTeam(team)
                    .build(),
                account,
        ...
        it('renders qualifier fixture', async () => {
            ...
            await renderComponent(
                {fixture, date, readOnly: false, beforeReloadDivision, onUpdateFixtures},
                divisionDataBuilder(division)
                    .withFixtureDate((d: IDivisionFixtureDateBuilder) => d.withFixture(f => f.playing('HOME', 'AWAY').knockout()), date)
                    .season(s => s, 'SEASON')
                    .withTeam(team)
                    .build(),
                account,
        ...
        it('renders bye', async () => {
            ...
            await renderComponent(
                {fixture, date, readOnly: false, beforeReloadDivision, onUpdateFixtures},
                divisionDataBuilder(division)
                    .withFixtureDate((d: IDivisionFixtureDateBuilder) => d.withFixture(f => f.bye('HOME')), date)
                    .season(s => s, 'SEASON')
                    .withTeam(team)
                    .build(),
                account,
