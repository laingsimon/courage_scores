...
public class GameMatchDto : AuditedDto
{
    ...
    /// </summary>
    public GamePlayerDto[] HomePlayers { get; set; } = null!;

    /// <summary>
    /// Who played from the away team
    /// </summary>
    public GamePlayerDto[] AwayPlayers { get; set; } = null!;
    ...
    /// </summary>
    public GamePlayerDto[] OneEighties { get; set; } = null!;

    /// <summary>
    /// Who checked out with more than 100
    /// </summary>
    public NotablePlayerDto[] Over100Checkouts { get; set; } = null!;
}
