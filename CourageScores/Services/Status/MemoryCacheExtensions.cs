...
{
    private static readonly FieldInfo? MemoryCacheEntriesField = typeof(MemoryCache).GetField("_nonStringKeyEntries", BindingFlags.Instance | BindingFlags.NonPublic);
