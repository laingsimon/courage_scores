...
public class CosmosQueryParserTests
{
    ...
    [TestCase("select * from table where age 15", "State Error: An operator has already been recorded for this filter")]
    ...
    [TestCase("select (t.name) from table t", "Not Supported: Blocks are not supported in a Select")]
