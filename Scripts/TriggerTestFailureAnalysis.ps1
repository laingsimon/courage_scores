...
try
{
    Upsert-PullRequestComment -GitHubToken $AddCommentToken -Repo $Repo -PullRequestNumber $PullRequestNumber -Comments $Comments -Markdown "#### $($TestsCommentHeading)`n$($CommentText)"
}
catch
{
